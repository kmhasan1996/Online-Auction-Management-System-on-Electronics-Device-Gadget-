    ...
    public class SharedController : Controller
    {
        public JsonResult UploadImage()
        {
            ...
            try
            {
                ...
                var path = Path.Combine(Server.MapPath("/Areas/Admin/Contents/Images/Category/"), fileName);

                file.SaveAs(path);

                result.Data = new { Success = true, ImageURL = string.Format("/Areas/Admin/Contents/Images/Category/{0}", fileName) };
